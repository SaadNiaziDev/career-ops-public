...
- Wayfinder maps use `wayfinder:map`; child tickets use `wayfinder:<type>` and GitHub sub-issues or a task-list fallback.
- Prefer native issue dependencies; otherwise record `Blocked by: #<n>` in the child issue.
