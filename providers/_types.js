 ...
 * @property {string} [description] Job description text, populated by a provider
 *                               when its feed carries it and, for restricted
 *                               remote listings, by scan.mjs's trusted detail
 *                               page enrichment. Consumed by scan.mjs's
 *                               content_filter; an empty/absent value always
 *                               passes the content filter.
