...
// health check. Files prefixed with _ are never loaded as providers by the CLI.
// It stays separate from scan-engine.mjs so verify-portals.mjs can reuse the
// exact routing behavior without importing the scan orchestration.
