...
function atsPath(host: string, pathname: string): { host: string; path: string } {
...
export function normalizeVacancyUrl(raw: string): string | null {
  try {
...
export function vacancyIdFromUrl(raw: string): string | null {
