...
const CANONICAL_REPO = process.env.CAREER_OPS_UPSTREAM_REPO || 'https://github.com/SaadNiaziDev/career-ops-public.git';
const RAW_VERSION_URL = process.env.CAREER_OPS_VERSION_URL || 'https://raw.githubusercontent.com/SaadNiaziDev/career-ops-public/main/VERSION';
const RELEASES_API = process.env.CAREER_OPS_RELEASES_API || 'https://api.github.com/repos/SaadNiaziDev/career-ops-public/releases/latest';
...
const SYSTEM_PATHS = [
  ...
  'role-matcher.mjs',
  'tracker-utils.mjs',
  'tracker-mutations.mjs',
  'tracker-parse.mjs',
  'tracker-aliases.json',
  'set-status.mjs',
  'set-status-tests.mjs',
  'test-tracker-mutations.mjs',
  ...
  'build-cv-html.mjs',
  'cv-md-preview.mjs',
  'cv-render-config.mjs',
  'cv-templates.mjs',
  'render-cv.mjs',
  'test/cv-renderer.test.mjs',
  'test/fixtures/cv-render/',
...
const REEXEC_FALLBACK_FILES = ['update-system.mjs', 'skill-entrypoints.mjs'];
...
async function apply() {
  ...
  try {
    ...
    const { ensureSkillEntrypoints } = await import('./skill-entrypoints.mjs');
